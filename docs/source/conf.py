...
latex_documents = [
    (master_doc, 'muarch.tex', 'muarch Documentation',
     'Daniel Bok', 'manual'),
]
...
man_pages = [
    (master_doc, 'muarch', 'muarch Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'muarch', 'muarch Documentation',
     author, 'muarch', 'One line description of project.',
     'Miscellaneous'),
]
